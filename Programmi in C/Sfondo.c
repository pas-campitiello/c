/* ___________________________________________________..:: S F O N D O . c ::..___________________________________________________
 ...
 PRIMAVERA, ESTATE, AUTUNNO, INVERNO):
  1) genera un numero a caso compreso tra 0 e NumImgDir (che è il numero delle immagini presenti in ciascuna cartella);
  2) dalla data di sistema vede qual'è il mese al momento dell'esecuzione. Seguendo poi questo schema:
