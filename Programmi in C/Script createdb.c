...
int main()
{
    ...
    ConcatenaStringhe(sC,"createdb -U ",nome);
    ConcatenaStringhe(sC,sC," ASFdb");
    system(sC);

    ConcatenaStringhe(sC,"psql -U ",nome);
    ConcatenaStringhe(sC,sC," ASFdb -f istruzionidb.sql");
    system(sC);
    
    
    
    ConcatenaStringhe(sC,"createdb -U ",nome);
    ConcatenaStringhe(sC,sC," ASFdbTest");
    system(sC);

    ConcatenaStringhe(sC,"psql -U ",nome);
    ConcatenaStringhe(sC,sC," ASFdbTest -f istruzionidb.sql");
    system(sC);
